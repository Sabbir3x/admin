  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Home Page Content Management</h2>
        <p className="text-sm text-gray-600 mb-6">Manage your website's home page content, images, and sections.</p>
        
        <div className="space-y-6">
          {/* Hero Section */}
          <div className="bg-gray-50 p-4 rounded-lg">
            <h3 className="text-md font-semibold mb-4 text-gray-800">Hero Section</h3>
            <div className="space-y-4">
              ...
              />
              <div>
                <h4 className="font-medium mb-3 text-gray-700">Background Images</h4>
                ...
                <button 
                  onClick={() => handleAddImageSource(setHeroImages)} 
                  className="flex items-center space-x-2 text-blue-600 hover:text-blue-800 mt-3 px-3 py-2 border border-blue-200 rounded-lg hover:bg-blue-50 transition-colors"
                >
          ...
          {/* Stats Section */}
          <div className="bg-gray-50 p-4 rounded-lg">
            <h3 className="text-md font-semibold mb-4 text-gray-800">Stats Section</h3>
            <div className="space-y-4">
                {stats.map(stat => (
                    <div key={stat.id} className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 bg-white border border-gray-200 rounded-lg">
                        <input 
                          type="text" 
                        ...
                        <button 
                          ...
                          className="p-2 text-red-500 hover:bg-red-100 rounded-lg self-center justify-self-end transition-colors"
                        >
            ...
            <button 
              ...
              className="flex items-center space-x-2 text-blue-600 hover:text-blue-800 mt-4 px-3 py-2 border border-blue-200 rounded-lg hover:bg-blue-50 transition-colors"
            >
              <Plus className="w-4 h-4" />
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <h3 className="text-md font-semibold mb-4 text-gray-800">Services Preview</h3>
            <div className="space-y-4">
                {servicesPreview.map(service => (
                    <div key={service.id} className="p-4 bg-white border border-gray-200 rounded-lg space-y-4">
                        ...
                        <input 
                          ...
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" 
                        />
                        <h5 className="font-medium text-gray-700">Service Image</h5>
            ...
            <button 
              onClick={handleAddServicePreview} 
              className="flex items-center space-x-2 text-blue-600 hover:text-blue-800 mt-4 px-3 py-2 border border-blue-200 rounded-lg hover:bg-blue-50 transition-colors"
            >
              <Plus className="w-4 h-4" />
              <span className="text-sm">Add Service Preview</span>
            </button>
          </div>

          {/* CTA Section */}
          <div className="bg-gray-50 p-4 rounded-lg">
            <h3 className="text-md font-semibold mb-4 text-gray-800">Call-to-Action (CTA) Section</h3>
            <div className="space-y-4">
              <input 
                type="text" 
...
const ImageEditor: React.FC<ImageEditorProps> = ({ image, onChange, onRemove, isNested }) => (
    <div className={`p-4 border border-gray-200 rounded-lg space-y-3 bg-white ${isNested ? '' : 'mb-3'}`}>
        <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
                <button 
                  onClick={() => onChange('type', 'url')} 
                  className={`px-3 py-2 text-sm rounded-lg flex items-center space-x-1 transition-colors ${image.type === 'url' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                >
                  <Link2 size={14}/>
                  <span>URL</span>
                </button>
                <button 
                  ...
                  className={`px-3 py-2 text-sm rounded-lg flex items-center space-x-1 transition-colors ${image.type === 'file' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                >
                  <Upload size={14}/>
                  <span>Upload</span>
                </button>
        ...
        {image.type === 'file' && (
            <input 
              ...
              className="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 border border-gray-300 rounded-lg" 
            />
        )}
        ...
        {(image.preview || (image.type === 'url' && image.value)) && (
            <div className="mt-2">
                <img 
                  ...
                  alt="Preview" 
                  className="w-full max-w-xs h-24 object-cover rounded-lg bg-gray-100 border border-gray-200"
                />
            </div>
        )}
    </div>
